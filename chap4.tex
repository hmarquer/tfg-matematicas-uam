...
\begin{ejem}[de función en $\mathscr{S}$ sin extensión continua a $\bar{\mathbb{D}}$]
    ...
    \]
    Por lo tanto, $\Re \left( \frac{1 + z}{1 - z} \right) = \frac{1 - x^2 - y^2}{(1-x)^2 + y^2} > 0$, ya que el numerador es positivo (pues $x^2 + y^2 < 1$) y el denominador es positivo. Así, $\abs{f(z)} < 1$ para todo $z \in \mathbb{D}$, lo que demuestra que $f \in \mathscr{S}$.
...
Sin embargo, si nos limitamos a subconjuntos compacto de $\mathbb{D}$, podemos aproximar cualquier función en $\mathscr{S}$ por productos finitos de Blaschke.

\begin{lem}\label{lem:aprox-clase-schur-prod-finito-blaschke-orden-cero}
    $\forall n \in \N, f \in \exhyperref[defn:clase-schur]{clase-schur}{\mathscr{S}} : \exists B_n$ \exhyperref[defn:producto-finito-blaschke]{producto-finito-blaschke}{producto finito de Blaschke} $: \exhyperref[defn:orden-cero-fn-holomorfa]{orden-cero-fn-holomorfa}{\operatorname{ord}}(f - B_n, 0) \geq n$.
\end{lem}
\begin{dem}
    Lo probaremos por inducción en $n$. Para $n = 1$ y $f \in \mathscr{S}$ arbitraria, basta tomar $B_1(z) = \exhyperref[defn:involucion-disco-unidad]{involucion-disco-unidad}{\tau_{c_0}}(z)$, ya que entonces $(f - B_1)(0) = f(0) - \tau_{c_0}(0) = c_0 - c_0 = 0$.

    Sea $n \in \N$, supongamos que $\forall f \in \mathscr{S} : \exists B_n$ producto finito de Blaschke $ : \operatorname{ord}(f - B_n, 0) \geq n$. Sea $f \in \mathscr{S}$. Definimos $g \colon \mathbb{D} \to \C$ mediante
    \[
    \forall z \in \mathbb{D} \setminus \{0\} : g(z) = \frac{\tau_{c_0}(f(z))}{z}.
    \]
    Por un lado, como $\tau_{c_0} (f(0)) = \tau_{c_0}(c_0) = 0$, $g$ se puede prolongar de forma holomorfa a todo $\mathbb{D}$. Por otro lado, como $f \in \mathscr{S}$ y $\tau_{c_0} \in \mathrm{Aut} (\mathbb{D})$, se tiene que $\tau_{c_0} \circ f \in \mathscr{S}$ y, como además $\tau_{c_0} (f(0)) = 0$, el \exhyperref[lem:schwarz]{lem-schwarz}{lema de Schwarz} nos garantiza que $\forall z \in \mathbb{D} : \abs{\tau_{c_0} (f(z))} \leq \abs{z}$. En consecuencia, $\forall z \in \mathbb{D} : \abs{g(z)} \leq 1$, es decir, $g \in \mathscr{S}$.
...
\begin{dem}
    ...
    \]
    Por otro lado, $\norm{f - B_n}_{\infty} = \sup_{z \in \mathbb{D}} \abs{f(z) - B_n(z)} \leq \sup_{z \in \mathbb{D}} \abs{f(z)} + \sup_{z \in \mathbb{D}} \abs{B_n(z)} \leq 2$, ya que $f, B_n \in \mathscr{S}$. Por lo tanto, $\norm{g_n}_{\infty} = \norm{z^{n-1} g_n}_{\infty} = \norm{f - B_n}_{\infty} \leq 2$.

    Entonces, $h_n \defeq \sfrac{g_n}{2} \in \mathscr{S}$ y $h(0) = 0$, luego, por el \exhyperref[lem:schwarz]{lem-schwarz}{lema de Schwarz}, $\forall z \in \mathbb{D} : \abs{h_n(z)} \leq \abs{z}$. En consecuencia, $\forall z \in \mathbb{D} : \abs{f(z) - B_n (z)} = \abs{z^{n-1} g_n(z)} = 2 \abs{z^{n-1} h_n(z)} \leq 2 \abs{z}^n$.
...
\begin{dem}
    ...
    Ahora bien, como $f \in \mathscr{S}$, por el \excref[teo:caratheodory-aproximacion-schur-prod-finito-blaschke-compactos]{teo-caratheodory-aproximacion-schur-prod-finito-blaschke-compactos}, $\exists B$ producto finito de Blaschke tal que $\sup_{z \in \overline{t\mathbb{D}}} \abs{f(z) - B(z)} < \sfrac{\varepsilon}{2}$. Como además se cumple que
    \[
