...
\begin{teo}[Fisher]\label{teo:fisher-aproximacion-algebra-disco-conv-prod-finito-blaschke}
    ...
    \[
    \exists \left(f_n\right)_{n\in \N} \subset \exhyperref[defn:envoltura-convexa]{envoltura-convexa}{\operatorname{conv}} (\exhyperref[defn:producto-finito-blaschke]{producto-finito-blaschke}{\mathscr{B}}) : f_n \exhyperref[defn:convergencia-uniforme]{convergencia-uniforme}{\xrightrightarrows[n \to \infty]{\overline{\mathbb{D}}}} f.
    \]
\end{teo}
\begin{dem}
    ...
    Además, por el \excref[lem:dilatacion-prod-finito-blaschke]{lem-dilatacion-prod-finito-blaschke}, $B_t$ es una combinación convexa de productos finitos de Blaschke. Como $\varepsilon > 0$ es arbitrario, tomando $\varepsilon = \sfrac{1}{n}$ para $n \in \N$ obtenemos una sucesión $\left(f_n\right)_{n \in \N} \subset \exhyperref[defn:envoltura-convexa]{envoltura-convexa}{\operatorname{conv}}(\mathscr{B})$ tal que $f_n$ converge uniformemente a $f$ en $\overline{\mathbb{D}}$.\hfill\qedsymbol
\end{dem}
...
\begin{dem}
    ...
    $\exists h \colon \mathbb{T} \to \C$ dada por $h(\zeta) = \sum_{k=-N}^N a_k \zeta^k$ tal que $\max_{\xi \in \mathbb{T}} \abs{\eta(\xi) - h(\xi)} < \frac{\varepsilon}{2}$. Entonces, como $\eta$ es unimodular y $\varepsilon < 1$, $h$ no se anula en $\mathbb{T}$. Definimos $P(z) \defeq z^N h(z) = \sum_{k=0}^{2N} b_k z^k$ y consideramos el \hyperref[defn:polinomio-conjugado-reverso]{polinomio conjugado reverso} dado por $P^{\#_{2N}}(z) \defeq z^{2N} \overline{P\left(\sfrac{1}{\bar{z}}\right)}$. Para $z \in \mathbb{T}$, definimos $h^{\#}(z) \defeq \overline{h\left(\sfrac{1}{\bar{z}}\right)} = \frac{P^{\#_{2N}}(z)}{z^N}$ y podemos definir $f(z) \defeq \frac{h(z)}{h^{\#}(z)} = \frac{P(z)}{P^{\#_{2N}}(z)}$, que es meromorfa en $\mathbb{D}$ y continua en $\mathbb{T}$ porque $P^{\#_{2N}}$ no se anula en $\mathbb{T}$.
    \[
    \begin{aligned}
...
%     \[
%     \iff P_f(\Gamma) = \!\!\!\!\!\!\!\!\!\!\!\sum_{\substack{z \in \operatorname{int}(\Gamma) \\ z \text{ es un \exhyperref[defn:polo-fn-meromorfa]{polo-fn-meromorfa}{polo} de } f}} \!\!\!\!\!\!\!\!\!\!\! \exhyperref[defn:orden-polo-fn-meromorfa]{orden-polo-fn-meromorfa}{\operatorname{ord}}(f, z).
%     \]
% \end{defn}
...
\begin{obs}\label{obs:challener-rubel-implica-glicksberg}
    Sean $f, g \in \exhyperref[defn:fn-holomorfa]{fn-holomorfa}{\mathcal{H}} \left(D(0, R)\right)$ con $R> 1$ y sin ceros en $\mathbb{T}$. Sean $B_1, B_2$ \exhyperref[defn:fn-holomorfa]{fn-holomorfa}{productos finitos de Blaschke de grado $n$} tales que $\abs{B_1 f + B_2 g} < \abs{f} + \abs{g}$ en $\mathbb{T}$. Entonces, $\abs{B_1 f - B_2 g} < \abs{B_1 f} + \abs{B_2 g}$ en $\mathbb{T}$, luego por el \hyperref[teo:glicksberg]{teorema de Glicksberg}, $\exhyperref[defn:numero-ceros-fn-holomorfa-camino]{numero-ceros-fn-holomorfa-camino}{Z_{B_1 f}}(\mathbb{T}) = \exhyperref[defn:numero-ceros-fn-holomorfa-camino]{numero-ceros-fn-holomorfa-camino}{Z_{B_2 g}}(\mathbb{T})$. Es decir, $n + \exhyperref[defn:numero-ceros-fn-holomorfa-camino]{numero-ceros-fn-holomorfa-camino}{Z_f}(\mathbb{T}) = n + \exhyperref[defn:numero-ceros-fn-holomorfa-camino]{numero-ceros-fn-holomorfa-camino}{Z_g}(\mathbb{T})$, luego $\exhyperref[defn:numero-ceros-fn-holomorfa-camino]{numero-ceros-fn-holomorfa-camino}{Z_f}(\mathbb{T}) = \exhyperref[defn:numero-ceros-fn-holomorfa-camino]{numero-ceros-fn-holomorfa-camino}{Z_g}(\mathbb{T})$.
