...
\begin{obs}
    ...
    Entonces, por el \excref[cor:carac-prod-finito-blaschke-algebra-disco]{cor-prod-finito-blaschke-algebra-disco}, $f$ es un producto finito de Blaschke. En particular, los productos finitos de Blaschke forman un subconjunto de $\mathscr{S}$ cerrado bajo la topología de la convergencia uniforme en $\mathbb{D}$. El siguiente ejemplo muestra que también se trata de un subconjunto propio.
\end{obs}
...
\begin{dem}
    ...
    \]
    y análogamente $\abs{1 - \bar{c_0} z B_n(z)} > 0$. Luego $G_2 \in \mathcal{H}(\mathbb{D})$, y por tanto $G_2G_1 \in \mathcal{H}(\mathbb{D})$. En consecuencia, $\operatorname{ord}(f - B_{n+1}, 0) \geq n+1$. 
